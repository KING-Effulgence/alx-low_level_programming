...
/**
 * sorted_list - inserts new node in sorted hash table
...
/**
 * shash_table_print - prints the key:value from the hash table
 * @ht: pointer to hash table
 *
 */
...
/**
 * shash_table_delete - frees the hash table and all nodes
 * @ht: pointer to hash table
 *
 */
